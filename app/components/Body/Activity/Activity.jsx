...
const Activity = () => {
  ...
  return (
    <div>
      <div className='row mb-s u__disp--flex'>
        <div className="u__align--left col-3">
          <h1 className="captionxl u__align--left u__fs__h1 mb-none">Hello, user.</h1>
        </div>
        <div className="u__align--left col-9">
          <QuickAccess></QuickAccess>
        </div>
      </div>
      <hr />
      <div className='row mt-l mb-xl'>
        <div className='col-9'>
          <News />
        </div>
      </div>
      ...
      <div className="row mt-l mb-l">
        <div className="u__align--left col-12">
          <h3 className='u__align--left mb-none'>Activity from last time</h3>
      ...
      <div className="row">
        <div className="u__align--left col-12">
          <h3 className="u__align--left mb-none">Featured Now</h3>
      ...
      <div className="row mt-xl">
        <div className="u__align--left col-12">
          <h3 className="u__align--left mb-none">Discover</h3>
